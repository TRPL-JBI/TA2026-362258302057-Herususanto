<?php
/**
 * Template Name: Pengumuman Poliwangi
 * Description: Halaman Pengumuman Poliwangi
 *
 * @package Astra
 */
...
<div class="poliwangi-page-wrapper">
    ...
    <section class="poliwangi-hero">
        <div class="poliwangi-container">
            <h1 class="poliwangi-hero-title">Pengumuman</h1>
            <p class="poliwangi-hero-subtitle">
                Informasi terbaru seputar kegiatan dan perkuliahan
            </p>
        </div>
    </section>
        ...
        <div class="poliwangi-container">
            <div class="poliwangi-empty-state">
                ...
                <p class="poliwangi-empty-text">
                    Halaman ini sedang dalam pengembangan. Pengumuman terbaru akan segera ditampilkan di sini.
                </p>
            </div>
        </div>
    </main>

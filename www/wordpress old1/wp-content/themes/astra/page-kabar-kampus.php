<?php
/**
 * Template Name: Kabar Kampus Poliwangi
 * Description: Halaman Kabar Kampus Poliwangi
 *
 * @package Astra
 */
...
<div class="poliwangi-page-wrapper">
    ...
    <section class="poliwangi-hero">
        <div class="poliwangi-container">
            <h1 class="poliwangi-hero-title">Kabar Kampus</h1>
            <p class="poliwangi-hero-subtitle">
                Berita dan prestasi mahasiswa serta dosen
            </p>
        </div>
    </section>
        ...
        <div class="poliwangi-container">
            <div class="poliwangi-empty-state">
                ...
                <p class="poliwangi-empty-text">
                    Halaman ini sedang dalam pengembangan. Kabar kampus terbaru akan segera ditampilkan di sini.
                </p>
            </div>
        </div>
    </main>
